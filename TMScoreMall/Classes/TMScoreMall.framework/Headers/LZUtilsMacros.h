...
#ifndef LZUtilsMacros_h
#define LZUtilsMacros_h
...
#define MyFramworkXib_Bundle [NSBundle bundleWithPath: [[NSBundle mainBundle] pathForResource:@"TMScoreMallXib" ofType: @"bundle"]]

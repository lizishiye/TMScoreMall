...
#define NoNetworkBack  if (![YHNetManager sharedYHNetManager].isReachable) {LZHideProgress LZShowHud(@"无网络") return nil;}
...
//        UIWebView * webView = [[UIWebView alloc]initWithFrame:CGRectMake(0, Nav_height, ScreenWidth, ScreenHeight-Nav_height)];
//        [window addSubview:webView];
//        UIButton * btn = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, ScreenWidth, 44)];
//        btn.backgroundColor = ColorHex(feaeae);
//        [btn setTitle:@"退出"];

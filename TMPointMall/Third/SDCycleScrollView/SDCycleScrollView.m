...
- (void)setupMainView
{
    ...
    [mainView registerNib:[UINib nibWithNibName:@"SXWeatherView" bundle:nil] forCellWithReuseIdentifier:@"SXWeatherView"];
...
- (void)setImageURLStringsGroup:(NSArray *)imageURLStringsGroup
{
    ...
    //增加一个空数剧
    NSMutableArray * array = [NSMutableArray arrayWithArray:imageURLStringsGroup];

    
    _imageURLStringsGroup = array;

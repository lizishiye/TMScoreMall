...
#define LZHideProgress dispatch_async(dispatch_get_main_queue(), ^{[[CustomProcess share] dismiss];});

#define LZShowProgress dispatch_async(dispatch_get_main_queue(), ^{[[CustomProcess share] show];});


@interface CustomProcess : UIView

//
//  g01jfsc_zk65mHJVideoPlayManager.m
//  HJVideoPlayer
//
...
@interface g01jfsc_zk65mHJVideoPlayManager ()
// 播放相关
...
/** 播放记录 */
@property (nonatomic, strong) NSMutableArray<g01jfsc_zk65mHJVideoPlayTimeRecord *> *playRecords;
...
@implementation g01jfsc_zk65mHJVideoPlayManager

ServiceSingletonM(g01jfsc_zk65mHJVideoPlayManager)
...
- (NSMutableArray<g01jfsc_zk65mHJVideoPlayTimeRecord *> *)playRecords{
...
- (void)recordUrl:(NSString *)url playTime:(float)playTime{
    ...
    g01jfsc_zk65mHJVideoPlayTimeRecord * record = [self recordWithUrl:url];
    if(!record){
        record = [[g01jfsc_zk65mHJVideoPlayTimeRecord alloc] init];
    }
    record.url = url;
...
- (g01jfsc_zk65mHJVideoPlayTimeRecord *)recordWithUrl:(NSString *)url{
    
    __block g01jfsc_zk65mHJVideoPlayTimeRecord * record = nil;
    [self.playRecords enumerateObjectsUsingBlock:^(g01jfsc_zk65mHJVideoPlayTimeRecord * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
...
- (void)record:(g01jfsc_zk65mHJVideoPlayTimeRecord *)record{
...
- (void)removeRecord:(g01jfsc_zk65mHJVideoPlayTimeRecord *)record{

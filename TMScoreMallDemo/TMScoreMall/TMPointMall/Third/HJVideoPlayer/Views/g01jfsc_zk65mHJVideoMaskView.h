//
//  g01jfsc_zk65mHJVideoMaskView.h
//  HJVideoPlayer
//
...
@interface g01jfsc_zk65mHJVideoMaskView : UIView
...
/** 快进视图 */
@property (nonatomic, strong, readonly) g01jfsc_zk65mHJFastForwardView *fastForwardView;
/** 是否暂停中 */

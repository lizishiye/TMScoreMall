//
//  g01jfsc_zk65mHJVideoPlayerController.m
//  HJVideoPlayer
//
...
#import "g01jfsc_zk65mHJVideoPlayerController.h"
#import "g01jfsc_zk65mHJVideoTopView.h"
#import "g01jfsc_zk65mHJVideoBottomView.h"
#import "g01jfsc_zk65mHJVideoPlayManager.h"
#import "g01jfsc_zk65mHJVideoUIManager.h"
#import "g01jfsc_zk65mHJPlayerView.h"
#import <MediaPlayer/MediaPlayer.h>
#import "g01jfsc_zk65mHJViewFactory.h"
#import "g01jfsc_zk65mHJVideoMaskView.h"
#import "g01jfsc_zk65mHJVideoPlayerHeader.h"
#import "g01jfsc_zk65mHJVideoPlayerUtil.h"
#import "UIDevice+g01jfsc_zk65mHJVideoRotation.h"
#import "g01jfsc_zk65mHJVideoConst.h"
#import "g01jfsc_zk65mHJVideoPlayTimeRecord.h"
...
@interface g01jfsc_zk65mHJVideoPlayerController ()

@property (nonatomic ,strong) g01jfsc_zk65mHJVideoMaskView * maskView;

@property (nonatomic ,strong) g01jfsc_zk65mHJVideoTopView * topView;

@property (nonatomic ,strong) g01jfsc_zk65mHJVideoBottomView * bottomView;

@property (nonatomic ,assign) CGRect originFrame;

@property (nonatomic, assign) BOOL isFullScreen;

@property (nonatomic, strong) g01jfsc_zk65mHJPlayerView *playerView;
...
@implementation g01jfsc_zk65mHJVideoPlayerController
...
- (void)setupUI
{
    ...
    //设置遮罩层
    self.maskView = [[g01jfsc_zk65mHJVideoMaskView alloc] initWithFrame:self.playerView.bounds];
    ...
    __weak g01jfsc_zk65mHJVideoMaskView * weakMaskView = self.maskView;
...
- (void)changeFullScreen:(BOOL)changeFull{
    ...
    if (changeFull) {
        ...
        [self.orangeView addSubview:self.view];
    }
...
- (void)play{
    ...
    if ([kVideoPlayerManager recordWithUrl:self.url]) {
        g01jfsc_zk65mHJVideoPlayTimeRecord * record = [kVideoPlayerManager recordWithUrl:self.url];
...
- (g01jfsc_zk65mHJVideoTopView *)topView{
    if (!_topView) {
        WS(weakSelf);
        _topView = [[g01jfsc_zk65mHJVideoTopView alloc]init];
        _topView.backBlock = ^(){
...
- (g01jfsc_zk65mHJVideoBottomView *)bottomView{
    if (!_bottomView) {
        WS(weakSelf);
        _bottomView = [[g01jfsc_zk65mHJVideoBottomView alloc] init];
...
- (g01jfsc_zk65mHJPlayerView *)playerView{
    if (!_playerView) {
        _playerView = [[g01jfsc_zk65mHJPlayerView alloc] init];
    }
    return _playerView;
}
...
- (g01jfsc_zk65mHJVideoConfigModel *)configModel{
    
    if (!_configModel) {
        _configModel = [[g01jfsc_zk65mHJVideoConfigModel alloc] init];
        _configModel.autoPlay = NO;//默认设置url不自动播放
    }
    return _configModel;
}

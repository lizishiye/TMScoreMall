//
//  g01jfsc_zk65mHJVideoBottomView.m
//  HJVideoPlayer
//
...
#import "g01jfsc_zk65mHJBufferSlider.h"
#import "g01jfsc_zk65mHJVideoTimeUtil.h"
...
@interface g01jfsc_zk65mHJVideoBottomView ()
...
/** 缓冲进度条 */
@property (nonatomic, strong) g01jfsc_zk65mHJBufferSlider *bufferSlider;
/** 是否仅显示slider */
...
@implementation g01jfsc_zk65mHJVideoBottomView
...
{
    if (!_fullScreenBtn) {
        _fullScreenBtn = [g01jfsc_zk65mHJViewFactory buttonWithNormalImage:imgFullScreen selectedImage:imgHalfScreen];
...
- (g01jfsc_zk65mHJBufferSlider *)bufferSlider
{
    if (!_bufferSlider) {
        _bufferSlider = [[g01jfsc_zk65mHJBufferSlider alloc]initWithFrame:CGRectMake(0, -kSliderHeight/2.f, CGRectGetWidth(self.frame), kSliderHeight)];
        [_bufferSlider setProgressTrackColor:[UIColor colorWithRed:186 green:0 blue:0 alpha:1]];
...
- (void)setProgress:(CGFloat)progressValue{
    ...
    [self.playTimeLbl setText:[NSString stringWithFormat:@"%@",[g01jfsc_zk65mHJVideoTimeUtil hmsStringWithFloat:progressValue]]];
}
...
- (void)setMaximumValue:(CGFloat)value{
    ...
    [self.totalDurationLbl setText:[NSString stringWithFormat:@"%@",[g01jfsc_zk65mHJVideoTimeUtil hmsStringWithFloat:value]]];
}

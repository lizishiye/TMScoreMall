...
@interface g01jfsc_zk65mHJVideoTopView ()
...
@implementation g01jfsc_zk65mHJVideoTopView
...
{
    if (!_backBtn) {
        _backBtn = [g01jfsc_zk65mHJViewFactory buttonWithNormalImage:imgBack selectedImage:nil];

//
//  g01jfsc_zk65mHJVideoMaskView.m
//  HJVideoPlayer
//
...
#import "g01jfsc_zk65mHJCircleLoading.h"
#import "g01jfsc_zk65mHJVideoConst.h"
#import "g01jfsc_zk65mHJViewFactory.h"

@interface g01jfsc_zk65mHJVideoMaskView ()
...
/** 快进视图 */
@property (nonatomic, strong) g01jfsc_zk65mHJFastForwardView *fastForwardView;
/** 加载视图 */
@property (nonatomic, strong) g01jfsc_zk65mHJCircleLoading *circleLoading;
...
@implementation g01jfsc_zk65mHJVideoMaskView
...
{
    if (!_playBtn) {
        _playBtn = [g01jfsc_zk65mHJViewFactory buttonWithNormalImage:imgPlay selectedImage:imgPause];
...
- (g01jfsc_zk65mHJFastForwardView *)fastForwardView{
    if (!_fastForwardView) {
        _fastForwardView = [[g01jfsc_zk65mHJFastForwardView alloc] init];
        ...
        [_fastForwardView configForwardLeftImage:[UIImage imageFromBundleWithName:@"video_farword_left"] forwardRightImage:[UIImage imageFromBundleWithName:@"video_farword_right"]];
        
//        [UIImage imageFromBundleWithName:@"video_slider_thumb"]
...
- (g01jfsc_zk65mHJCircleLoading *)circleLoading{
    if (!_circleLoading) {
        _circleLoading = [[g01jfsc_zk65mHJCircleLoading alloc] init];
